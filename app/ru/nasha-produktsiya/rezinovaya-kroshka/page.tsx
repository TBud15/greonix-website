...
export default function Page() {
  return (
    <div className="ml-80 font-inter">
          ...
          <div>
            ...
            <div className="w-145">
              ...
              <p className="mt-5">
                ...
                various bodily functions, including the maintenance of healthy
                skin, blood vessels, bones, and cartilage. It also helps with
                wound healing and acts as an antioxidant. Vitamin C, also known
                as ascorbic acid, is a vital nutrient for various bodily
                functions, including the maintenance of healthy skin, blood
                vessels, bones, and cartilage. It also helps with wound healing
                and acts as an antioxidant. Read more...
              </p>
            </div>
