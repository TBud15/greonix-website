    ...
    <div className="flex flex-col lg:flex-row items-center gap-6 justify-center px-6 lg:px-0 py-10 lg:py-0">
      ...
      <div className="flex flex-col gap-4 font-inter text-center lg:text-left">
        ...
        <p className="text-gray-600 w-full lg:w-160">
          We produce crumb rubber on next-generation automated production lines,
          which guarantees consistent quality, precise fraction size, and full
          compliance with European standards. Our products are in demand in
          construction, road infrastructure, landscaping, and sports projects.
        </p>
