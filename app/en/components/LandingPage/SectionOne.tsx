  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center font-inter bg-[#F5F7FA] pt-32 pb-10 px-6 lg:px-0">
      ...
      <div className="text-center lg:text-left">
        <p className="text-4xl sm:text-5xl lg:text-6xl">Durability</p>
        <p className="text-4xl sm:text-5xl lg:text-6xl mt-4">Ecology</p>
        <p className="text-4xl sm:text-5xl lg:text-6xl mt-4">Safety</p>
        <p className="text-gray-600 mt-6 max-w-md lg:max-w-none">
          Crumb rubber from the manufacturer - for surfaces of any complexity.
        </p>
